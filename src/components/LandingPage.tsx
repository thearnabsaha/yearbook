...
export default function LandingPage({ onEnterApp, yearbookCount }: LandingPageProps) {
  ...
  return (
    <div className="relative min-h-screen bg-[#fbf9f5] text-[#1c1917] overflow-x-hidden selection:bg-[#c27838]/20 selection:text-[#a85d26]">
      ...
      {/* Top Navigation Bar */}
      <header className="sticky top-0 z-50 border-b border-[#e7e1d3]/80 bg-[#fbf9f5]/85 backdrop-blur-xl transition-all">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-3.5 py-2.5 sm:px-6 sm:py-3">
          <div className="flex items-center gap-2 sm:gap-2.5">
            <div className="relative flex h-8 w-8 sm:h-9 sm:w-9 items-center justify-center rounded-xl overflow-hidden shadow-xs ring-1 ring-[#c27838]/20 shrink-0">
              <img
          ...
          <div className="flex items-center gap-2 shrink-0">
            <button
              onClick={onEnterApp}
              className="group flex items-center gap-1.5 rounded-full bg-[#1c1917] px-4 py-1.5 text-xs font-semibold text-white shadow-xs hover:bg-[#c27838] transition-all duration-200 cursor-pointer"
            >
